...
for(b=0:4)
    ...
    ret=shallowwater_4dvarnew('synthetic_21_1_day.mat',params);
    save(strcat("results_synthetic_1_day_4dvar",num2str(b),".mat"));
end
...
for(i1=1:3)
    for(i2=1:3)
        for(i3=1:6)
            ...
            params.prioruv=0.001;
            params.priorh=0.001;
            ret=shallowwater_hybrid4dvar_climat('synthetic_21_1_day.mat',params);
            save(strcat("results_synthetic_1_day_hybrid",num2str(i1),"_",num2str(i2),"_",num2str(i3), ".mat"));
        end
    end
end