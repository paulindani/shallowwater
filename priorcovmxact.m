...
% 
% u2=idct2(SSOARcov.*dct2(u2))/prioruv;
% v2=idct2(SSOARcov.*dct2(v2))/prioruv;
% h2=idct2(SSOARcov.*dct2(h2))/priorh;
% 
% CV=[reshape(u2,[1,d2]),reshape(v2,[1,d2]),reshape(h2,[1,d2])];
end
